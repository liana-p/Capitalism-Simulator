...
export const factoriesData: IFactoryData[] = [
    ...
    },
    {
        ...
        baseCost: 1130,
        costIncreasePercent: 25,
        upgradeLevels: [0, 10, 50, 100, 150, 200, 250, 300, 400, 500, 600, 700, 800, 1000, 10000, 100000],
    ...
    },
    {
        ...
        upgradeLevels: [0, 10, 100, 200, 250, 300, 400, 500, 600, 700, 800, 1000, 10000, 100000],
